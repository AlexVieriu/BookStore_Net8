...
public class NewBaseRepository<T> : INewBaseRepository<T> where T : class
{
    private readonly BookStoreContext _context;
    private readonly IMapper _mapper;

    public NewBaseRepository(BookStoreContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }

    public async Task<bool> Create<TMap>(TMap entityDto) where TMap : class
    {
